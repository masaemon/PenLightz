...
<body>
    <section class="section">
        <div class="container">
            <h1 class="title">Obnizの登録</h1>
            <h2 class="subtitle">Obnizを登録しましょう</h2>
        </div>
    </section>
    <section class="section">
        <div class="container">
            <form action="add_obniz_submit.php" method="get">
                <p class="title is-4">ObnizIDの入力</p>
                <input class="input is-rounded is-primary" type="text" placeholder="XXXX-XXXX" name="obnizid">
                <input class="button is-primary is-rounded" id="submit" type="submit" value="登録">
            </form>
        </div>
    </section>
</body>
