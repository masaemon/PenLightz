...
$pdo=new PDO("sqlite:./WPmusic.sqlite");  
$pdo->query("INSERT INTO WPmusic VALUES(null,'$title','$dougaid',null,'$thumbnail')");
$pdo->query('DELETE FROM WPmusic WHERE id=(select min(id) from WPmusic)');
